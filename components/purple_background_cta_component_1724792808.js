    ...
    <div id="section-container" class="max-w-6xl mx-auto px-4 sm:px-6 bg-white">
      <div id="content-container" class="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
        ...
        <div id="content" class="max-w-3xl mx-auto text-center">
          ...
          <button
            id="shoryuken-button"
            class="mt-4 btn transition duration-150 ease-in-out text-white hover:text-yellow-300 bg-gradient-to-r from-red-600 to-orange-400 hover:from-red-500 hover:to-orange-300 rounded-full px-6 py-3 shadow-lg flex items-center"
